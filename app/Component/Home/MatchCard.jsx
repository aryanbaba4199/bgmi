...
const TournamentCard = ({ match, setShowJoinForm }) => {
  ...
  return (
    <>
        ...
        <Pressable onPress={() => setShowJoinForm(match)} style={styles.card}>
          {/* Game Type and Map */}
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity style={styles.joinButton}>
              <Text style={styles.joinText}>₹{fee} Join →</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.detailButton}>
              <Text style={styles.detailText}>Match Details</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.detailButton}>
              <Text style={styles.detailText}>Id & Password</Text>
            </TouchableOpacity>
          </View>
          {status==='finished' && 
          <>
